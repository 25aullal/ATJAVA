...
public class GraphicsTemplatePartA {
    /*
    ...
    public static void draw(Graphics g) {
        ...
        g.fillArc(100, 150, 200, 200, 180, 180);
        ...
        g.fillArc(170, 225, 60, 120, 180, 180);
        
       
    }

    //theta = 0. theta1 = theta0 + dtheta.  incrementing theta until 2 pi
    //r = cos(2theta)
    //xplot = 200-x prime
    //yplot = 200- yprime
    //g.fillrect(xplot,yplot,1,1)

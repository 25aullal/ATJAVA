...
public class GraphicsTemplatePartC_AT {
    /*
     * Change the following method to customize
     * what is drawn in the JFrame.
     */
    public static void draw(Graphics g) {
        //just some background building :)
        g.setColor(Color.MAGENTA);
        g.fillRect(0, 0, 400, 400);
        g.setColor(Color.CYAN);
        g.fillOval(0, 0, 400, 400);
        g.setColor(Color.BLACK);
        //Change to increase/decrease line strength
        int howManyPoints = 10000;
        //Change to increase/decrease size (scale)
        int scale = 200;
        //how much are we changing per loop!
        final double deltatheta = 2*Math.PI/howManyPoints;
